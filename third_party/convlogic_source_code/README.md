> [!IMPORTANT]
> This folder serves as an archive of the ConvLogic repository available at
> https://github.com/lkorinek/convlogic, which has been used to reproduce the
> TreeLogicNet baseline models.
