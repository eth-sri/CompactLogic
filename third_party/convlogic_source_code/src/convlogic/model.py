...
class ConvLogicCifarModel(nn.Module):
    ...
    def __init__(self, k_param=32, input_channels=3, input_size=32, tau=20, implementation="cuda", num_classes=10, num_chn=2):
        super().__init__()
        ...
        fc_dims = [
            ...
            self.extra_layers * (flat * num_classes) // 4,
        ]
...
class ConvLogicMnistModel(nn.Module):
    ...
    def __init__(self, input_channels=1, input_size=28, k_param=32, tau=6.5, implementation="cuda", num_chn=2):
        super().__init__()
...
class ConvLogicModel(pl.LightningModule):
    def __init__(self, config):
        ...
        elif ds.startswith("tinyimagenet"):
